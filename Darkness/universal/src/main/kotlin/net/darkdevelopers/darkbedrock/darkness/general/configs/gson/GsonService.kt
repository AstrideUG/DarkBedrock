...
object GsonService {
     ...
     */
    fun load(configData: ConfigData): JsonElement =
        load(configData.file)
     ...
     * @since 1.0 (20.10.2018 - 20.10.2018)
     */
    fun loadAsJsonObject(configData: ConfigData): JsonObject =
        loadAsJsonObject(configData.file)
     ...
     * @since 1.0 (20.10.2018 - 20.10.2018)
     */
    fun loadAsJsonArray(configData: ConfigData): JsonArray =
        loadAsJsonArray(configData.file)
    ...
    fun loadAsJsonObject(file: File): JsonObject =
        loadAs(
            file,
            "JsonObject",
            { file.isFile and (it.isJsonObject or (file.length() == 0L)) },
            {
    ...
    fun loadAsJsonArray(file: File): JsonArray =
        loadAs(
            file,
            "JsonArray",
            { file.isFile and (it.isJsonArray or (file.length() == 0L)) },
            {
