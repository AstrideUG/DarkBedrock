...
data class ItemBuilder(private val itemStack: ItemStack) : IItemBuilder {
    ...
    override fun setFireworkMetaEffect(fireworkEffect: Iterable<FireworkEffect>): IItemBuilder = ignoreClassCastException {
        (itemMeta as FireworkMeta).addEffects(fireworkEffect)
	 ...
	 *PotionMeta Add
	 */
    override fun addCustomEffect(potionEffect: PotionEffect, overwrite: Boolean): IItemBuilder = ignoreClassCastException {
