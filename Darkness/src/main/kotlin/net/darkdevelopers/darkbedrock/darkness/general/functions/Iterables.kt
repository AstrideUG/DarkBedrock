 ...
 */
@Suppress("unused")
fun <K : Any?, V : Any?> Map<K, V>.check(value1: KClass<*>, value2: KClass<*>, vararg values2: KClass<*>): Map<K, V> = check(setOf(value1), setOf(value2, *values2))
 ...
 * @since 17.10.2018
 */
fun <V : Any?> KClass<*>.castedInstanceAndNotNull(value: V): V? = if (this.isInstanceAndNotNull(value)) this as? V else null
 ...
 * @since 17.10.2018
 */
fun <K : Any?, V : Any?> of(function: MutableMap<K, V>.() -> Unit): Map<K, V> = mutableMapOf<K, V>().apply(function).toMap()