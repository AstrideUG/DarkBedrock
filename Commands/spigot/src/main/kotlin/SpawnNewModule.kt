...
class SpawnNewModule @Inject private constructor(@DataDirectory private val path: Path) {
...
//        commandManager.commands += SetSpawnCommand::class.java
    ...
    private inner class SpawnCommand : Command(
        ...
        config.permissions.getNotNull("SpawnNewModule.Command.Spawn")
    ) {
    ...
    private inner class SetSpawnCommand : Command(
        ...
        config.permissions.getNotNull("SpawnNewModule.Command.SetSpawn")
    ) {
        ...
        override fun perform(sender: CommandSender, args: Array<String>) = sender.isPlayer {
            ...
            this@SpawnNewModule.location = location
...
//     */
//    @Command("Spawn")
//    @Permission("SpawnNewModule.commands.<CommandName>")
