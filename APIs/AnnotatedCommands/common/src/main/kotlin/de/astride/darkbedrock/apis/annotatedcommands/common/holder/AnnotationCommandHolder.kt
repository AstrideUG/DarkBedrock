...
class AnnotationCommandHolder(private val argSeparator: String) : HashSet<Class<*>>(), CommandHolder {
     ...
     * @throws IllegalArgumentException If [element] has a [Method] with [Annotation] [SubCommand] and this has an [Arg] with a [Value] by finding [argSeparator]
     *
     * In German:
     * @throws IllegalArgumentException Wenn [element] eine [Method] hat mit der [Annotation] [SubCommand] und diese ein [Arg], mit einem [Value] hat, indem [argSeparator] gefunden wurde
     *
     * Current Version: 1.0 (13.12.2018 - 15.12.2018)
     */
    override fun add(element: Class<*>): Boolean {
        ...
        SubCommandAMS.registerWithAnnotation(element).checkValues()
     ...
     */
    private fun Map<Method, SubCommand>.checkValues() = entries.forEach { (method, annotation) ->
